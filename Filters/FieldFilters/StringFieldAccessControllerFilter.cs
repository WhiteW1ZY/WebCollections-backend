...
{
    public class StringFieldAccessControllerFilter : Attribute, IAuthorizationFilter
    {
        private readonly ApplicationContext _context;

        public StringFieldAccessControllerFilter(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            var field = _context.StringFields
                .Include(i => i.item)
