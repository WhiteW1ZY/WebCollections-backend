...
{
    public class DateFieldAccessControllerFilter : Attribute, IAuthorizationFilter
    {
        private readonly ApplicationContext _context;

        public DateFieldAccessControllerFilter(ApplicationContext context)
        {
            _context = context;
        }
