...
{
    public class BooleanFieldAccessControllerFilter : Attribute, IAuthorizationFilter
    {
        private readonly ApplicationContext _context;

        public BooleanFieldAccessControllerFilter(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            var field = _context.BooleanFields
                .Include(i => i.item)
